    ...
    <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
        <div id="yangjae" class="tab-pane fade">
            ...
            <c:forEach items="${UploadVideoList}" var="difficult">
                <c:choose>
                    <c:when test="${difficult.branch eq 'Yangjae'}">
                                ...
                                <div class="video-container">
                                    ...
                                    <div style="display: flex;">
                                        <form action="updateUploadVideo.do" method="post">
                                            ...
                                            <input type="hidden" value="yangjae" name="branch">
                                        ...
                                        <form action="insertBoardGrade.do" method="post">
                                            <table>
                                                <tr>
                                                    ...
                                                    <td><input type="button" value="댓글 보기 "
                                                            onclick="toggleComments(${difficult.seq});">
                                                    </td>
                                                </tr>
                                            </table>
                                                            ...
                                                            <c:when test="${board.category eq difficult.seq}">
                                                                <c:if test="${loop.index < 20}">
                                                                    <tr>
                                                                        <c:choose>
                                                                            <c:when
                                                                                test="${board.writer eq sessionScope.id}">
                                                                                <!-- 내가 쓴 글 -->
                                                                                <td
